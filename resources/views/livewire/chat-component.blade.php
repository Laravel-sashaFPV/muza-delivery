                    ...
                    <div class="">
                                ...
                                <div>
                                    <div class="dropdown chat-noti-dropdown active">
                                        <button class="btn" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <i class="bx bx-border-all bx-tada"></i>
                                        </button>
                        ...
                        <div class="search-box chat-search-box py-4">
                            <div class="position-relative">
                                ...
                                <i class="bx bxs-archive search-icon"></i>
                            </div>
                        </div>
                            ...
                            <div class="tab-content py-4">
                                <div class="tab-pane show active" id="chat">
                                    <div>
                                        ...
                                        <ul class="list-unstyled chat-list" data-simplebar="init" style="max-height: 410px;"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: -15.4545px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: auto; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 0px;">
                                                                <li class="active">
                                ...
                                <div class="tab-pane" id="contacts">
                                    ...
                                    <div data-simplebar="init" style="max-height: 410px;"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: auto; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
                                                        ...
                                                        </div></div></div></div><div class="simplebar-placeholder" style="width: 0px; height: 0px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="transform: translate3d(0px, 0px, 0px); display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar" style="transform: translate3d(0px, 0px, 0px); display: none; height: 287px;"></div></div></div>
                                                        ...
                                                        <li>
                                                            <div class="conversation-list">
                                                                ...
                                                                <div class="ctext-wrap">
                                                                    ...
                                                                    <p class="chat-time mb-0"><i class="bx bx-music"></i> 10:00</p>
                                                                </div>
                                                        ...
                                                        <li class="right">
                                                            <div class="conversation-list">
                                                                ...
                                                                <div class="ctext-wrap">
                                                                    ...
                                                                    <p class="chat-time mb-0"><i class="bx bx-music"></i> 10:02</p>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <div class="conversation-list">
                                                                ...
                                                                <div class="ctext-wrap">
                                                                    ...
                                                                    <p class="chat-time mb-0"><i class="bx bx-music"></i> 10:06</p>
                                                                </div>
                                                        ...
                                                        <li class=" right">
                                                            <div class="conversation-list">
                                                                ...
                                                                <div class="ctext-wrap">
                                                                    ...
                                                                    <p class="chat-time mb-0"><i class="bx bx-music"></i> 10:07</p>
                                                                </div>
                                                            </div>
                                                        </li>


                                                    </div></div></div></div><div class="simplebar-placeholder" style="width: auto; height: 644px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="transform: translate3d(0px, 0px, 0px); display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 366px; transform: translate3d(0px, 0px, 0px); display: block;"></div></div></ul>
                            </div>
